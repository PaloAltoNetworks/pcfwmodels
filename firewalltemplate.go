...
func (o *FirewallTemplate) GetBSON() (interface{}, error) {
...
func (o *FirewallTemplate) ValueForAttribute(name string) interface{} {
...
// GetBSON implements the bson marshaling interface.
// This is used to transparently convert ID to MongoDBID as ObectID.
func (o *SparseFirewallTemplate) GetBSON() (interface{}, error) {
