...
func (o *AWSFirewall) Validate() error {
	...
	if err := elemental.ValidateStringInList("status", string(o.Status), []string{"Creating", "Updating", "Deleting", "Ready", "Failed"}, true); err != nil {
		errors = errors.Append(err)
	}
...
var AWSFirewallAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"Status": {
		AllowedChoices: []string{"Creating", "Updating", "Deleting", "Ready", "Failed"},
		Autogenerated:  true,
