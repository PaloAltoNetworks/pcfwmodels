...
func (o FirewallRulesetsList) Copy() elemental.Identifiables {
	...
	copy := append(FirewallRulesetsList{}, o...)
	return &copy
}
...
func (o *FirewallRuleset) GetBSON() (interface{}, error) {
...
func (o *FirewallRuleset) GetTags() []string {

	return o.Tags
}

// SetTags sets the property Tags of the receiver using the given value.
func (o *FirewallRuleset) SetTags(tags []string) {
...
func (o *FirewallRuleset) ValueForAttribute(name string) interface{} {
...
// GetBSON implements the bson marshaling interface.
// This is used to transparently convert ID to MongoDBID as ObectID.
func (o *SparseFirewallRuleset) GetBSON() (interface{}, error) {
...
// GetTags returns the Tags of the receiver.
func (o *SparseFirewallRuleset) GetTags() (out []string) {
...
func (o *SparseFirewallRuleset) SetTags(tags []string) {
