...
var FirewallFQDNListIdentity = elemental.Identity{
	Name:     "firewallfqdnlist",
	Category: "firewallfqdnlists",
	Package:  "ngfw",
	Private:  false,
}
...
func (o FirewallFQDNListsList) Identity() elemental.Identity {
	...
	return FirewallFQDNListIdentity
}
...
func (o FirewallFQDNListsList) Append(objects ...elemental.Identifiable) elemental.Identifiables {
	...
	for _, obj := range objects {
		out = append(out, obj.(*FirewallFQDNList))
	}
...
// ToSparse returns the FirewallFQDNListsList converted to SparseFirewallFQDNListsList.
// Objects in the list will only contain the given fields. No field means entire field set.
func (o FirewallFQDNListsList) ToSparse(fields ...string) elemental.Identifiables {

	out := make(SparseFirewallFQDNListsList, len(o))
	for i := 0; i < len(o); i++ {
		out[i] = o[i].ToSparse(fields...).(*SparseFirewallFQDNList)
	}
...
type FirewallFQDNList struct {
	// List of FQDNs.
	FQDNs []string `json:"FQDNs" msgpack:"FQDNs" bson:"-" mapstructure:"FQDNs,omitempty"`
...
func (o *FirewallFQDNList) GetBSON() (interface{}, error) {

	if o == nil {
		return nil, nil
	}

	s := &mongoAttributesFirewallFQDNList{}
...
func (o *FirewallFQDNList) GetTags() []string {

	return o.Tags
}

// SetTags sets the property Tags of the receiver using the given value.
func (o *FirewallFQDNList) SetTags(tags []string) {
...
func (o *FirewallFQDNList) Patch(sparse elemental.SparseIdentifiable) {
	...
	so := sparse.(*SparseFirewallFQDNList)
	if so.FQDNs != nil {
		o.FQDNs = *so.FQDNs
	}
	if so.ID != nil {
...
func (o *FirewallFQDNList) DeepCopyInto(out *FirewallFQDNList) {
	...
	if err != nil {
		panic(fmt.Sprintf("Unable to deepcopy FirewallFQDNList: %s", err))
	}

	*out = *target.(*FirewallFQDNList)
}
...
func (o *FirewallFQDNList) Validate() error {
	...
	if err := elemental.ValidateRequiredExternal("FQDNs", o.FQDNs); err != nil {
		requiredErrors = requiredErrors.Append(err)
	}

	if err := ValidateFQDNList("FQDNs", o.FQDNs); err != nil {
...
func (*FirewallFQDNList) SpecificationForAttribute(name string) elemental.AttributeSpecification {
	...
	if v, ok := FirewallFQDNListAttributesMap[name]; ok {
		return v
	}

	// We could not find it, so let's check on the lower case indexed spec map
	return FirewallFQDNListLowerCaseAttributesMap[name]
}

// AttributeSpecifications returns the full attribute specifications map.
func (*FirewallFQDNList) AttributeSpecifications() map[string]elemental.AttributeSpecification {

	return FirewallFQDNListAttributesMap
}

// ValueForAttribute returns the value for the given attribute.
// This is a very advanced function that you should not need but in some
// very specific use cases.
func (o *FirewallFQDNList) ValueForAttribute(name string) interface{} {
...
var FirewallFQDNListAttributesMap = map[string]elemental.AttributeSpecification{
	"FQDNs": {
...
var FirewallFQDNListLowerCaseAttributesMap = map[string]elemental.AttributeSpecification{
	"fqdns": {
		AllowedChoices: []string{},
		ConvertedName:  "FQDNs",
		Description:    `List of FQDNs.`,
...
func (o SparseFirewallFQDNListsList) Copy() elemental.Identifiables {
	...
	copy := append(SparseFirewallFQDNListsList{}, o...)
	return &copy
}
...
func (o SparseFirewallFQDNListsList) Append(objects ...elemental.Identifiable) elemental.Identifiables {
	...
	out := append(SparseFirewallFQDNListsList{}, o...)
	for _, obj := range objects {
		out = append(out, obj.(*SparseFirewallFQDNList))
	}
...
type SparseFirewallFQDNList struct {
	// List of FQDNs.
	FQDNs *[]string `json:"FQDNs,omitempty" msgpack:"FQDNs,omitempty" bson:"-" mapstructure:"FQDNs,omitempty"`
...
// GetBSON implements the bson marshaling interface.
// This is used to transparently convert ID to MongoDBID as ObectID.
func (o *SparseFirewallFQDNList) GetBSON() (interface{}, error) {

	if o == nil {
		return nil, nil
	}

	s := &mongoAttributesSparseFirewallFQDNList{}
...
// GetTags returns the Tags of the receiver.
func (o *SparseFirewallFQDNList) GetTags() (out []string) {
...
func (o *SparseFirewallFQDNList) SetTags(tags []string) {
...
func (o *SparseFirewallFQDNList) DeepCopyInto(out *SparseFirewallFQDNList) {
	...
	target, err := copystructure.Copy(o)
	if err != nil {
		panic(fmt.Sprintf("Unable to deepcopy SparseFirewallFQDNList: %s", err))
	}

	*out = *target.(*SparseFirewallFQDNList)
}

type mongoAttributesFirewallFQDNList struct {
...
type mongoAttributesSparseFirewallFQDNList struct {
	ID          bson.ObjectId `bson:"_id,omitempty"`
