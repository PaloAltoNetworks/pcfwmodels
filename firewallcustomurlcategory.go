...
const (
	// FirewallCustomURLCategoryActionAlert represents the value Alert.
	FirewallCustomURLCategoryActionAlert FirewallCustomURLCategoryActionValue = "Alert"

	// FirewallCustomURLCategoryActionAllow represents the value Allow.
	FirewallCustomURLCategoryActionAllow FirewallCustomURLCategoryActionValue = "Allow"

	// FirewallCustomURLCategoryActionBlock represents the value Block.
	FirewallCustomURLCategoryActionBlock FirewallCustomURLCategoryActionValue = "Block"

	// FirewallCustomURLCategoryActionNone represents the value None.
	FirewallCustomURLCategoryActionNone FirewallCustomURLCategoryActionValue = "None"
)

// FirewallCustomURLCategoryIdentity represents the Identity of the object.
var FirewallCustomURLCategoryIdentity = elemental.Identity{
	Name:     "firewallcustomurlcategory",
	Category: "firewallcustomurlcategories",
	Package:  "ngfw",
	Private:  false,
}
...
func (o FirewallCustomURLCategoriesList) Identity() elemental.Identity {
	...
	return FirewallCustomURLCategoryIdentity
}
...
func (o FirewallCustomURLCategoriesList) Append(objects ...elemental.Identifiable) elemental.Identifiables {
	...
	for _, obj := range objects {
		out = append(out, obj.(*FirewallCustomURLCategory))
	}
...
// ToSparse returns the FirewallCustomURLCategoriesList converted to SparseFirewallCustomURLCategoriesList.
// Objects in the list will only contain the given fields. No field means entire field set.
func (o FirewallCustomURLCategoriesList) ToSparse(fields ...string) elemental.Identifiables {

	out := make(SparseFirewallCustomURLCategoriesList, len(o))
	for i := 0; i < len(o); i++ {
		out[i] = o[i].ToSparse(fields...).(*SparseFirewallCustomURLCategory)
	}
...
type FirewallCustomURLCategory struct {
	// Identifier of the object.
	ID string `json:"ID" msgpack:"ID" bson:"-" mapstructure:"ID,omitempty"`

	// List of URIs.
	URIs []string `json:"URIs" msgpack:"URIs" bson:"uris" mapstructure:"URIs,omitempty"`
...
func (o *FirewallCustomURLCategory) GetBSON() (any, error) {
	...
	s := &mongoAttributesFirewallCustomURLCategory{}
...
func (o *FirewallCustomURLCategory) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	sp := &SparseFirewallCustomURLCategory{}
...
func (o *FirewallCustomURLCategory) Patch(sparse elemental.SparseIdentifiable) {
	...
	so := sparse.(*SparseFirewallCustomURLCategory)
	if so.ID != nil {
		o.ID = *so.ID
	}
	if so.URIs != nil {
...
func (o *FirewallCustomURLCategory) DeepCopyInto(out *FirewallCustomURLCategory) {
	...
	if err != nil {
		panic(fmt.Sprintf("Unable to deepcopy FirewallCustomURLCategory: %s", err))
	}

	*out = *target.(*FirewallCustomURLCategory)
}
...
func (o *FirewallCustomURLCategory) Validate() error {
	...
	if err := elemental.ValidateRequiredExternal("URIs", o.URIs); err != nil {
		requiredErrors = requiredErrors.Append(err)
	}

	if err := ValidateURLs("URIs", o.URIs); err != nil {
		errors = errors.Append(err)
	}

	if err := elemental.ValidateStringInList("action", string(o.Action), []string{"None", "Alert", "Allow", "Block"}, false); err != nil {
		errors = errors.Append(err)
	}
...
func (*FirewallCustomURLCategory) SpecificationForAttribute(name string) elemental.AttributeSpecification {
	...
	if v, ok := FirewallCustomURLCategoryAttributesMap[name]; ok {
		return v
	}

	// We could not find it, so let's check on the lower case indexed spec map
	return FirewallCustomURLCategoryLowerCaseAttributesMap[name]
}

// AttributeSpecifications returns the full attribute specifications map.
func (*FirewallCustomURLCategory) AttributeSpecifications() map[string]elemental.AttributeSpecification {

	return FirewallCustomURLCategoryAttributesMap
}
...
var FirewallCustomURLCategoryAttributesMap = map[string]elemental.AttributeSpecification{
	"ID": {
	...
	"Action": {
		AllowedChoices: []string{"None", "Alert", "Allow", "Block"},
		BSONFieldName:  "action",
		ConvertedName:  "Action",
		DefaultValue:   FirewallCustomURLCategoryActionNone,
...
var FirewallCustomURLCategoryLowerCaseAttributesMap = map[string]elemental.AttributeSpecification{
	"id": {
		AllowedChoices: []string{},
		Autogenerated:  true,
		BSONFieldName:  "_id",
...
func (o SparseFirewallCustomURLCategoriesList) Copy() elemental.Identifiables {
	...
	copy := append(SparseFirewallCustomURLCategoriesList{}, o...)
	return &copy
}
...
func (o SparseFirewallCustomURLCategoriesList) Append(objects ...elemental.Identifiable) elemental.Identifiables {
	...
	out := append(SparseFirewallCustomURLCategoriesList{}, o...)
	for _, obj := range objects {
		out = append(out, obj.(*SparseFirewallCustomURLCategory))
	}
...
type SparseFirewallCustomURLCategory struct {
	// Identifier of the object.
	ID *string `json:"ID,omitempty" msgpack:"ID,omitempty" bson:"-" mapstructure:"ID,omitempty"`

	// List of URIs.
	URIs *[]string `json:"URIs,omitempty" msgpack:"URIs,omitempty" bson:"uris,omitempty" mapstructure:"URIs,omitempty"`
...
func (o *SparseFirewallCustomURLCategory) GetBSON() (any, error) {
	...
	s := &mongoAttributesSparseFirewallCustomURLCategory{}
...
func (o *SparseFirewallCustomURLCategory) ToPlain() elemental.PlainIdentifiable {
	...
	out := NewFirewallCustomURLCategory()
	if o.ID != nil {
		out.ID = *o.ID
	}
	if o.URIs != nil {
...
func (o *SparseFirewallCustomURLCategory) DeepCopy() *SparseFirewallCustomURLCategory {
	...
	out := &SparseFirewallCustomURLCategory{}
	o.DeepCopyInto(out)
...
func (o *SparseFirewallCustomURLCategory) DeepCopyInto(out *SparseFirewallCustomURLCategory) {
	...
	target, err := copystructure.Copy(o)
	if err != nil {
		panic(fmt.Sprintf("Unable to deepcopy SparseFirewallCustomURLCategory: %s", err))
	}

	*out = *target.(*SparseFirewallCustomURLCategory)
}
