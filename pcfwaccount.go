...
type PCFWAccount struct {
	...
	LogQueryExternalID string `json:"LogQueryExternalID" msgpack:"LogQueryExternalID" bson:"logqueryexternalid" mapstructure:"LogQueryExternalID,omitempty"`
...
func (o *PCFWAccount) GetBSON() (any, error) {
	...
	s.LogQueryExternalID = o.LogQueryExternalID
...
func (o *PCFWAccount) SetBSON(raw bson.Raw) error {
	...
	o.ID = s.ID.Hex()
	o.LogQueryExternalID = s.LogQueryExternalID
...
func (o *PCFWAccount) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	if len(fields) == 0 {
		...
		return &SparsePCFWAccount{
			...
			ID:                   &o.ID,
			LogQueryExternalID:   &o.LogQueryExternalID,
	...
	for _, f := range fields {
		...
		case "ID":
			sp.ID = &(o.ID)
		case "LogQueryExternalID":
			sp.LogQueryExternalID = &(o.LogQueryExternalID)
		case "NGFWCFTHash":
...
func (o *PCFWAccount) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.LogQueryExternalID != nil {
		o.LogQueryExternalID = *so.LogQueryExternalID
	}
...
var PCFWAccountAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"LogQueryExternalID": {
		AllowedChoices: []string{},
		Autogenerated:  true,
		BSONFieldName:  "logqueryexternalid",
		ConvertedName:  "LogQueryExternalID",
	...
	"PCTenantIssuer": {
		AllowedChoices: []string{},
		Autogenerated:  true,
		BSONFieldName:  "pctenantissuer",
		ConvertedName:  "PCTenantIssuer",
		Description:    `Issuer for Prisma Cloud tenant (identifies the PC stack for IAM role usage).`,
		Exposed:        true,
		Name:           "PCTenantIssuer",
		ReadOnly:       true,
		Stored:         true,
...
type SparsePCFWAccount struct {
	...
	// External ID used in logQueryRole.
	LogQueryExternalID *string `json:"LogQueryExternalID,omitempty" msgpack:"LogQueryExternalID,omitempty" bson:"logqueryexternalid,omitempty" mapstructure:"LogQueryExternalID,omitempty"`
...
func (o *SparsePCFWAccount) ToPlain() elemental.PlainIdentifiable {
	...
	if o.LogQueryExternalID != nil {
		out.LogQueryExternalID = *o.LogQueryExternalID
	}
	if o.NGFWCFTHash != nil {
...
type mongoAttributesPCFWAccount struct {
	...
	LogQueryExternalID   string                             `bson:"logqueryexternalid"`
...
type mongoAttributesSparsePCFWAccount struct {
	...
	ID                   bson.ObjectId                       `bson:"_id,omitempty"`
	LogQueryExternalID   *string                             `bson:"logqueryexternalid,omitempty"`
